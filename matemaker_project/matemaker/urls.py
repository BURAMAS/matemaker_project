...
urlpatterns = [
    ...
    path('genres/<slug:genre_name>/<slug:interest_name>/add_post/', views.add_post, name='add_post'),
    path('genres/<slug:genre_name>/<slug:interest_name>/like/<int:post>/', views.like, name='like'),
